          ...
          {shipments.map((ship) => {
            ...
            return (
              <div 
                ...
                className={`bg-slate-900/40 backdrop-blur-md rounded-2xl p-5 border transition-all duration-700 relative overflow-hidden flex flex-col justify-between ${
                  isHighlight 
                    ? 'border-amber-500/50 shadow-[0_0_20px_rgba(245,158,11,0.15)] bg-slate-900/80 scale-[1.02]' 
